...
func main() {
    ...
    dt.AddTime(24, 10, 10) // 2018-01-02 00:10:10
    dt.SubTime(10, 5, 5) // 2018-01-01 00:05:05
    dt.AddDate(1, 2, 3) // 2019-03-04 00:05:05
    dt.SubDate(1, 2, 3) // 2018-01-01 00:05:05
    dt.AddSeconds(10) // 2018-01-01 00:05:15
    dt.SubSeconds(10) // 2018-01-01 00:05:05
    dt.AddMinutes(10) // 2018-01-01 00:15:05
    dt.SubMinutes(10) // 2018-01-01 00:05:05
    dt.AddHours(10) // 2018-01-01 10:05:05
    dt.SubHours(10) // 2018-01-01 00:05:05
    dt.AddDays(1) // 2018-01-02 00:05:05
    dt.SubDays(1) // 2018-01-01 00:05:05
    dt.AddMonths(1) // 2018-02-01 00:05:05
    dt.SubMonths(1) // 2018-01-01 00:05:05
    dt.AddYears(1) // 2019-01-01 00:05:05
    dt.SubYears(1) // 2018-01-01 00:05:05
