...
func TestFormatToStdLayout(t *testing.T) {
	...
	assertTrue(t, dm.formatToStdLayout("%Z") == "MST", "Format Zone Name")
}
...
func TestFormat(t *testing.T) {
	...
	assertTrue(t, dm.Format("%z") == "-0500", "Test: %z")
	assertTrue(t, dm.Format("%:z") == "-05:00", "Test: %:z")
	assertTrue(t, dm.Format("%::z") == "-05:00:00", "Test: %::z")
	assertTrue(t, dm.Format("%Z") == "EST", "Test zone abbreviation")
}
